...
| `Montage_Maker_User_Guide.pdf` | End-user guide (PDF — the Markdown source is in `Archive/` and gitignored) |
| `examples/` | Example output images referenced in the user guide (all 11 presets populated) |
